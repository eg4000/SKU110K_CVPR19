...
def _get_detections(generator, model, score_threshold=0.1, max_detections=300, save_path=None, save_detections=False, force_hard_score=False):
    ...
    score_type = 'hard' if force_hard_score else 'soft'
    res_file = result_dir + '/detections_output_iou_{}_{}.csv'.format(score_type, timestamp)
...
def evaluate(
    ...
    all_detections = _get_detections(generator, model, score_threshold=score_threshold,
                                     ...
                                     save_detections=save_detections, force_hard_score=force_hard_score)
